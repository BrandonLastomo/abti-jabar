<aside class="side !p-0 bg-white border-r border-gray-100 flex flex-col h-screen font-heading">
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-1">
        ...
        <!-- Dashboard -->
        <a href="{{ route('cms.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 {{ request()->routeIs('cms.dashboard') ? 'bg-primary text-white font-bold shadow-[0_4px_12px_rgba(220,38,38,0.2)] hover:-translate-y-0.5' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 font-medium' }}">
