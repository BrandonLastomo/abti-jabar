...
@section('title', 'Add Team Profile')
    ...
    <div class="sectionBody">
        <form action="{{ route('club.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <input type="text" name="subcategory" value="{{ old('subcategory') }}" placeholder="e.g. Senior putra" required>
            </div>
            ...
            <div class="field">
                ...
                <div class="image-section">
                    <div class="image-preview">
                        <img id="preview-image" src="https://via.placeholder.com/150x150" width="150" alt="Preview">
                    </div>
            ...
            <div class="actions" style="margin-top: 20px;">
                <button type="submit" class="btn primary">Save Team Profile</button>
            </div>
        </form>
