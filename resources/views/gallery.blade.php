    ...
    <section class="relative pt-24 pb-12 lg:pt-32 lg:pb-16 overflow-hidden bg-white" id="galleryHeader" aria-label="Gallery page header">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <h1 class="font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight mb-4 tracking-tight drop-shadow-sm">
                Galeri Kegiatan <br/><span class="text-primary">ABTI Jawa Barat</span>
            </h1>
                ...
                <div class="relative w-full flex items-center group/cardbar ihf-cardbar" aria-label="Event list">
                    ...
                    <div class="ihf-cardtrack w-full flex gap-6 overflow-x-auto snap-x snap-mandatory py-8 px-4 md:px-12 custom-scrollbar scroll-smooth" data-card-track>
                        @foreach($galleries as $gallery)
                            ...
                            >
                                <div class="bg-white/70 backdrop-blur-xl border border-white rounded-[2.5rem] p-3 shadow-xl shadow-gray-200/50 transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-2xl">
                                    <div class="w-full aspect-[4/5] rounded-[2rem] overflow-hidden relative ihf-cardimg">
                                        <img
                                        ...
                                        <div class="absolute bottom-0 left-0 w-full p-6 text-left ihf-cardmeta">
                                            <div class="inline-block px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-white text-xs font-bold uppercase tracking-wider mb-3 border border-white/30 ihf-cardsub">
                                                {{ $gallery->season }}
                                            </div>
                                            <h3 class="text-white font-bold text-xl leading-snug ihf-cardtitle">
                                                {{ $gallery->title }}
                                            </h3>
                                        </div>
                                    </div>
