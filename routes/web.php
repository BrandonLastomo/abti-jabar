...
Route::resource('/cms/big_news', BigNewsController::class);
...
Route::get('/cms/footer', [FooterContentController::class, 'index'])->name('footer.index');
Route::put('/cms/footer', [FooterContentController::class, 'update'])->name('footer.update');
